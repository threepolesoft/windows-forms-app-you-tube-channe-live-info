...
namespace CounterLib
{
    ...
    public class Counter : System.Windows.Forms.UserControl
    {
        ...
        private PanaCounter panaCounter = PanaCounter.No;
        ...
        [DefaultValue(PanaCounter.No)]
        [Category("Appearance")]
        [Description("The appearance of the digits")]
        public PanaCounter PanaCounter
        {
            get { return panaCounter; }
            set
            {
                panaCounter = value;

                if (panaCounter.ToString().ToString().Equals("Yes"))
                {
                    ReadNumbers1();
                }
                else
        ...
        private void ReadNumbers1()
        {
            if (null != numbersBitmap)
                numbersBitmap.Dispose();
            Stream s = this.GetType().Assembly.GetManifestResourceStream("CounterLib.n09.gif");
        ...
        private void ReadNumbers2()
        {
            if (null != numbersBitmap)
                numbersBitmap.Dispose();
            Stream s = this.GetType().Assembly.GetManifestResourceStream("CounterLib.n08.gif");
